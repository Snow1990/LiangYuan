...
class BenkeViewController: BaseCollectionViewController {
    ...
    func initTabBar() {
        ...
        self.navigationController?.tabBarItem.title = "本科"
...
//        leftView.addSubview(leftButton)
    ...
    @objc func initData() {
        ...
        let url = Network.Domain + "subject/course/2"
