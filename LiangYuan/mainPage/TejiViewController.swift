...
class TejiViewController: BaseCollectionViewController {
    ...
    func initTabBar() {
        ...
        self.navigationController?.tabBarItem.title = "特辑"
        self.navigationController?.tabBarItem.image = UIImage(named: "table_icon5_normal")
        self.navigationController?.tabBarItem.selectedImage = UIImage(named: "table_icon5_pressed")
...
//        leftView.addSubview(leftButton)
    ...
    @objc func initData() {
        ...
        let url = Network.Domain + "subject/course/4"
